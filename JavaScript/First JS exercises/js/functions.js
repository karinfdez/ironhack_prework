...
function dniLetter( dni ) {
	...
	var remainderNumber=dni%23;


    return lockup.charAt(remainderNumber);
...
function dniLetter( dni ) {
	...
	if(remainderNumber<0 || typeof remainderNumber !== 'string')
...
array_lengths.push( findLongestWord( ["Carlos", "Karin", "Mimi"] ) );
array_lengths.push( findLongestWord( ["Narelys", "Linda", "Gricelda"] ) );
array_lengths.push( findLongestWord( ["Lunesx", "Miercoles", "Sabado"] ) );
array_lengths.push( findLongestWord( [] ) );
...
function charFreq( string ) {
    ...
    count = (string.match(/a/g) || []).length;
    freqCounter.a=count;
	count = (string.match(/b/g) || []).length;
	freqCounter.b=count;
	count = (string.match(/c/g) || []).length;
	freqCounter.c=count;
	count = (string.match(/d/g) || []).length;
	freqCounter.d=count;
	count = (string.match(/f/g) || []).length;
	freqCounter.f=count;
	count = (string.match(/x/g) || []).length;
	freqCounter.x=count;
	count = (string.match(/y/g) || []).length;
	freqCounter.y=count;
	count = (string.match(/z/g) || []).length;
	freqCounter.z=count;
